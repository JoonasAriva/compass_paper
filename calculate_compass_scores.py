...
sd = torch.load('/scratch/project_465002884/results/compass/resnet18/2d_slice/2026-05-12/23-26-10/checkpoints/best.pth',
...
main_df.to_csv("train_set_compass_scores_2d_slice.csv", index=False)
...
with ctx:
    for i, batch in enumerate(loader):
        ...
        with torch.autocast(device_type="cuda"):
            ...
            main_df = pd.concat([main_df, df])
main_df.to_csv("test_set_compass_scores_2d_slice.csv", index=False)
